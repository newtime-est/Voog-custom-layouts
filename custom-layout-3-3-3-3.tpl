				...
				<div class="container">
					...
					<div class="custom-row">
						...
						{% endif %}
							...
							<div class="custom-col-sm-3">{% content name="main-content-2" %}</div>
							<div class="custom-col-sm-3">{% content name="main-content-3" %}</div>
							<div class="custom-col-sm-3">{% content name="main-content-4" %}</div>
							<div class="custom-col-sm-3">{% content name="main-content-5" %}</div>
						</div>
					</div>
					...
					<div class="custom-row">
						...
						{% endif %}
							...
							<div class="custom-col-sm-3">{% content name="main-content-6" %}</div>
							<div class="custom-col-sm-3">{% content name="main-content-7" %}</div>
							<div class="custom-col-sm-3">{% content name="main-content-8" %}</div>
							<div class="custom-col-sm-3">{% content name="main-content-9" %}</div>
						</div>
					</div>
					...
					<div class="custom-row">
						...
						{% endif %}
							...
							<div class="custom-col-sm-12">{% content name="main-content-10" %}</div>
						</div>
					</div>
				</div>
			</div>
