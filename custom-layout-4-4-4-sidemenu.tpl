...
<html class="{% if editmode %}editmode{% else %}public{% endif %}" lang="{{ page.language_code }}">
	...
	<body class="{% unless editmode %}no-overflow{% endunless %}">
		<div class="wrapper">
			<div class="sidemenu">
				<div class="logo">
			...
			<div class="main main--full-width main--with-sidemenu js-bg-data" style="background-color:{{ page.data.main-bg.color }}; background-image:url({{ page.data.main-bg.image }});">
				{% if editmode %}
				...
				<div class="container container--full-width">
					...
					<div class="custom-row">
						...
						{% endif %}
							...
							<div class="custom-col-sm-4">{% content name="main-content-2" %}</div>
							<div class="custom-col-sm-4">{% content name="main-content-3" %}</div>
							<div class="custom-col-sm-4">{% content name="main-content-4" %}</div>
						</div>
					</div>
					...
					<div class="custom-row">
						...
						{% endif %}
							...
							<div class="custom-col-sm-4">{% content name="main-content-5" %}</div>
							<div class="custom-col-sm-4">{% content name="main-content-6" %}</div>
							<div class="custom-col-sm-4">{% content name="main-content-7" %}</div>
						</div>
					</div>
					...
					<div class="custom-row">
						...
						{% endif %}
							...
							<div class="custom-col-sm-12">{% content name="main-content-8" %}</div>
						</div>
					</div>
				</div>
